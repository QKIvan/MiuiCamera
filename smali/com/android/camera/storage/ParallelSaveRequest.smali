...
.method private isSaveDocument(Ljava/lang/String;ILandroid/net/Uri;)Z
    ...
    invoke-virtual {v0}, Lcom/xiaomi/camera/core/ParallelTaskData;->getDocumentBean()Lcom/android/zxing/DocumentDecoder$DocumentBean;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/camera/storage/ParallelSaveRequest;->parseDocAndSave(IILcom/android/zxing/DocumentDecoder$DocumentBean;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)Z
...
.method private parseDocAndSave(IILcom/android/zxing/DocumentDecoder$DocumentBean;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)Z
    .locals 22
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportAnchorFrame"
    ...
    invoke-virtual/range {p3 .. p3}, Lcom/android/zxing/DocumentDecoder$DocumentBean;->getPreviewImage()Lcom/android/zxing/PreviewImage;

    move-result-object v2

    invoke-virtual/range {p3 .. p3}, Lcom/android/zxing/DocumentDecoder$DocumentBean;->getPoints()[F

    move-result-object v8

    invoke-virtual/range {p3 .. p3}, Lcom/android/zxing/DocumentDecoder$DocumentBean;->getDocEffect()Ljava/lang/String;
