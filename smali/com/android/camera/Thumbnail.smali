...
.method public static createThumbnail([BIILandroid/net/Uri;Z)Lcom/android/camera/Thumbnail;
    ...
    invoke-virtual {v1}, LOooO0OO/OooO0oO/OooO00o/OooO0OO;->o0Oo()Z
...
.method public static getLastThumbnailFromFile(Ljava/io/File;Landroid/content/ContentResolver;)Lcom/android/camera/Thumbnail;
    ...
    :try_start_0
    sget-object v5, Lcom/android/camera/Thumbnail;->sLock:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-static {v5, v0}, Lcom/android/camera/Util;->isUriValid(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    :cond_8
    invoke-static {v5, v0, v4, v4}, Lcom/android/camera/Thumbnail;->createThumbnail(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/Thumbnail;

    move-result-object v0

    if-eqz v0, :cond_9

    invoke-virtual {v0, v11}, Lcom/android/camera/Thumbnail;->setIsGif(Z)V

    invoke-virtual {v0, v12, v13}, Lcom/android/camera/Thumbnail;->setGifSize(II)V

    const/4 v2, 0x1

    invoke-virtual {v0, v2}, Lcom/android/camera/Thumbnail;->setFromFile(Z)V

    invoke-virtual {v0, v3}, Lcom/android/camera/Thumbnail;->setIsVideo(Z)V

    invoke-virtual {v0, v14, v15}, Lcom/android/camera/Thumbnail;->setFileSize(J)V
