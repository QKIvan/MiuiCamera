...
.method public A(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$b;->k(Landroid/support/v4/media/MediaDescriptionCompat;)V
...
.method public d(Landroid/view/KeyEvent;)Z
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$b;->i(Landroid/view/KeyEvent;)Z
...
.method public m()Ljava/util/List;
    ...
    invoke-interface {p0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->m()Ljava/util/List;
...
.method public n()Ljava/lang/CharSequence;
    ...
    invoke-interface {p0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->e()Ljava/lang/CharSequence;
...
.method public o()I
    ...
    invoke-interface {p0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->g()I
...
.method public v()Landroid/support/v4/media/session/MediaControllerCompat$f;
    ...
    invoke-interface {p0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->f()Landroid/support/v4/media/session/MediaControllerCompat$f;
...
.method public w()Z
    ...
    invoke-interface {p0}, Landroid/support/v4/media/session/MediaControllerCompat$b;->d()Z
...
.method public z(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
    ...
    invoke-interface {p0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$b;->n(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
