...
.method private static OooO(I)Z
    .locals 1
...
.method public final OooO0O0()I
    ...
    invoke-static {v1, v0}, Leb;->OooOOOo(ZLjava/lang/String;)V
...
.method public final OooO0OO([BLk;)V
    .locals 2
    ...
    invoke-static {p0}, Leb;->OooOOO(Ljava/lang/Object;)V

    invoke-interface {p0, p1, p2}, Lg;->OooO00o([BLk;)V
...
.method public final OooO0oO(I)V
    ...
    invoke-static {p1}, Lba;->OooO(I)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {v0}, Lba;->OooO(I)Z
    ...
    invoke-virtual {v1}, Laq;->OooO0oO()V

    :cond_0
    invoke-static {p1}, Lba;->OooOO0O(I)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-static {v0}, Lba;->OooOO0O(I)Z
    ...
    invoke-virtual {p0}, Laq;->OooO0oO()V

    :cond_1
    return-void
.end method

.method public final OooO0oo(Lg;)V
    .locals 7
    ...
    invoke-virtual {p0}, Lba;->OooOO0o()V
    ...
    invoke-virtual {p0, p1}, Lba;->OooO0oO(I)V
    ...
    invoke-virtual {p1}, Lde;->OooOOOo()Lda;
    ...
    :cond_2
    invoke-virtual {v0}, Lda;->OooO0o()V
    ...
    invoke-virtual {v0}, Lda;->OooOO0()Lde;
    ...
    :cond_3
    invoke-virtual {p1}, Lda;->OooO0o()V
    ...
    invoke-virtual {v3}, Lde;->OooOOOo()Lda;
    ...
    :cond_4
    invoke-virtual {v3}, Lda;->OooO0o()V
    ...
    invoke-static {v4}, Lr;->OooOOo0(Lr;)V

    invoke-virtual {v3}, Lda;->OooOO0()Lde;

    move-result-object v3

    check-cast v3, Lr;

    invoke-virtual {p1, v2, v3}, Ldb;->OooOO0O(Lcq;Ljava/lang/Object;)V

    invoke-virtual {p1}, Lda;->OooOO0()Lde;
    ...
    invoke-static {v2}, Leb;->OooOOO(Ljava/lang/Object;)V

    invoke-virtual {v0}, Lbu;->OooO0Oo()[B

    move-result-object v0

    invoke-interface {v2, v0}, Lg;->OooO0Oo([B)V

    iget-object v0, p0, Lba;->g:Lg;

    invoke-static {v0}, Leb;->OooOOO(Ljava/lang/Object;)V

    invoke-virtual {p1}, Lbu;->OooO0Oo()[B

    move-result-object p1

    invoke-interface {v0, p1}, Lg;->OooO0Oo([B)V
...
.method public final synthetic OooOO0([BLk;)V
    .locals 4
    ...
    invoke-static {v0}, Lcy;->OooO0O0(Ljava/lang/Class;)Lcs;
    ...
    invoke-static {v0, p1, v1}, Lde;->OooO0oo(Lde;[BLcs;)Lde;
    ...
    invoke-static {p2}, Lde;->OooOOO(Lcq;)Lcq;

    move-result-object p2

    invoke-virtual {p1, p2}, Ldc;->OooOOo0(Lcq;)V

    iget-object p1, p1, Ldc;->d:Lcu;

    iget-object v0, p2, Lcq;->d:Ldd;

    invoke-virtual {p1, v0}, Lcu;->OooO0OO(Ldd;)Ljava/lang/Object;
    ...
    :cond_9
    invoke-virtual {p2, p1}, Lcq;->OooO0O0(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v2}, Lba;->OooO0oO(I)V
    :try_end_1
...
.method public final OooOO0o()V
    ...
    invoke-virtual {p0, v0}, Lba;->OooO0oO(I)V
...
.method public final OooOOOo()V
    ...
    invoke-virtual {p0}, Lba;->OooOOOO()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lba;->OooOOO()Z
...
.method public final a()V
    ...
    invoke-virtual {v0}, Lde;->OooOOOo()Lda;
    ...
    invoke-virtual {v2}, Lde;->OooOOOo()Lda;
    ...
    :cond_1
    invoke-virtual {v2}, Lda;->OooO0o()V
    ...
    invoke-static {v3}, Lad;->OooOOo0(Lad;)V

    invoke-virtual {v2}, Lda;->OooOO0()Lde;

    move-result-object v2

    check-cast v2, Lad;

    invoke-virtual {v0, v1, v2}, Ldb;->OooOO0O(Lcq;Ljava/lang/Object;)V
    ...
    invoke-static {v1}, Leb;->OooOOO(Ljava/lang/Object;)V

    invoke-virtual {v0}, Lbu;->OooO0Oo()[B

    move-result-object v0

    invoke-interface {v1, v0}, Lg;->OooO0Oo([B)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final b()I
    ...
    invoke-virtual {p0}, Lba;->OooOOO0()Z
...
.method public final d()Z
    ...
    invoke-static {p0}, Lba;->OooOO0O(I)Z
